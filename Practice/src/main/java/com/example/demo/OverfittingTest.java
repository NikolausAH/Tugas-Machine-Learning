    ...
    public static void main(String[] args) {
        ...
        while (i < 60) {
            ...
            while (j < 20) {
                ...
                Double sigmoid = (1 / (1 + Math.exp(-h)));
                dataset.setSigmoid(j, sigmoid);
                Double error = (sigmoid - dataset.getKelasValidasi(j)) * (sigmoid - dataset.getKelasValidasi(j));
                dataset.setError(j, error);
            ...
            System.out.println("Epoch Validasi" + (i + 1) + ": " + jumlahError2);
...
//        end of code
        ...
        JFrame frame = new JFrame("Grafik perbandingan data training dan validasi");
